...
public class MainActivity extends Activity {
    ...
    private class eventsTask extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void s) {
            ...
            if(mEmpty){
                Toast.makeText(MainActivity.this,"NO EVENTS TO SHOW",Toast.LENGTH_LONG).show();
            }
            parseJson(mInfo);
        }
    }
    ...
    private void parseJson(String json){ //PARSE JSON WORKS ALREADY, FIXING GETTING THE STRING
        ...
        EventAdapter eventAdapter = new EventAdapter(MainActivity.this, R.layout.list_item);
